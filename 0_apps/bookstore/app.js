...
//acessing root should request users to use the /bookstore/api instead
app.get('/bookstore/',function(request,response){	
 response.send('use path /bookstore/api to get list of APIs');
});
